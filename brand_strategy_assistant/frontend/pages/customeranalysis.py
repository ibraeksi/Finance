...
user_reviews_data = os.path.join(rootpath, 'data/raw/', 'user_reviews_10k_v01.csv')
...
brand_customer_data = os.path.join(rootpath, 'frontend/modules/text/', 'brandcustomerinfo.json')
